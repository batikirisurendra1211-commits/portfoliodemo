...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenResume }) => {
  return (
    <section id="about" className="relative min-h-[100dvh] w-full bg-[#ECEAE5] text-[#222222] py-16 sm:py-24 px-6 sm:px-14 flex flex-col justify-between border-b border-black/10 select-none">
      ...
      <div className="w-full flex items-center justify-between text-xs font-mono uppercase tracking-[0.25em] text-[#666666] mb-8 sm:mb-12">
        <span className="font-bold text-[#222222] tracking-widest">[ 01 ] BIOGRAPHY &amp; CAPABILITIES</span>
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center flex-1 my-auto py-4 sm:py-6">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <div className="max-w-xl text-[#333333] font-normal text-sm sm:text-base leading-relaxed space-y-3 font-sans">
            <p>
            ...
            <p className="text-[#666666] text-xs sm:text-sm font-mono">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-4">
            <button
              ...
              className="px-7 py-3.5 rounded-full bg-[#111111] text-white font-mono font-bold text-xs uppercase tracking-widest hover:bg-[#C87A3E] transition-colors cursor-pointer flex items-center gap-2 shadow-sm"
            >
            ...
            <a
              ...
              className="px-7 py-3.5 rounded-full border border-black/20 text-[#111111] font-mono font-bold text-xs uppercase tracking-widest hover:border-[#C87A3E] hover:text-[#C87A3E] transition-colors flex items-center gap-2"
            >
              Live E-Commerce ↗
            </a>
          </div>
